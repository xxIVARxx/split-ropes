...
var segments := []
var head_anchor: CollisionObject3D
var tail_anchor: CollisionObject3D
...
func _generate_joint_between(body_a: CollisionObject3D, body_b: CollisionObject3D, priority: int = 1) -> PinJoint3D:
